...
export default function IOSPage() {
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <ModulePage
        title="Hệ điều hành iOS (Apple)"
        description="Hướng dẫn chi tiết cách cài đặt và sử dụng ứng dụng trên thiết bị iOS"
        ...
        {/* <div className="space-y-6">
          <div>
            ...
            <ol className="list-decimal list-inside space-y-2 text-muted-foreground">
              <li>Mở App Store trên thiết bị iOS của bạn</li>
              <li>Tìm kiếm "APEC SPACE"</li>
              <li>Nhấn nút "Tải về" để cài đặt ứng dụng</li>
